...
const SOCIALS = [
  ...
  { label: "Bear Spirits Arts", href: "#", short: "BA" },
      ...
      <div className={clsx('container-punk', 'py-16')}>
        <div className={clsx('grid', 'grid-cols-2', 'md:grid-cols-4', 'gap-10', 'mb-16')}>
          ...
          <div className={clsx('col-span-2', 'md:col-span-1')}>
            <p className={clsx('font-display', 'text-4xl', 'text-volt', 'tracking-widest', 'mb-4', 'uppercase')}>KYLE</p>
            <p className={clsx('font-mono', 'text-ghost', 'text-sm', 'leading-relaxed', 'max-w-xs')}>
              Creative digital artist building bold custom visuals, identity work,
              web experiments, and commission-ready design.
            </p>
          </div>
