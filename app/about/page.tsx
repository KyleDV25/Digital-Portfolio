      ...
      <section className="section-padding bg-ink border-y border-smoke">
        <div className="container-punk grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:pt-4">
            ...
            <MarkdownRenderer content={renderMarkdown(Array.isArray(pageConfig.bio) ? (typeof pageConfig.bio[0] === 'string' ? pageConfig.bio?.join("\n\n") || "" : pageConfig.bio?.map((b: any) => b.text).join("\n\n") || "") : pageConfig.bio || "")} className="mb-12" />
